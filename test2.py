...
def translate_to_english(text):
    ...
    clean_text = str(text).strip()[:500]  # Limit length to avoid payload block
    ...
    for attempt in range(2):
        try:
            ...
            # Agar Google ne 500 error page return kiya ho toh catch karein
    ...
    # Agar dono baar fail ho jaye toh original text return karega, error message nahi
    return clean_text
                    ...
                    try:
                        ...
                        if await clickable_icon.count() > 0:
                            ...
                            if popup_html:
                                ...
                                # Arabic extraction directly from popup text to save translation bandwidth
